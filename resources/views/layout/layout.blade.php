...
<body onunload="" class="loading " id="page-top"  >
  <div class="show_loader" style="display:none"> <div class="spinner-grow text-muted"></div></div>
  <div class="wrapper">    
    <nav id="sidebar" class="active">
        <div class="fixnav left_nav_hide">
            <div class="sidebar-header">
                <img loading="lazy" src="assets/images/qr-code-chimp-white.svg">
            </div>
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="pricing.html">Purchase Plan</a>
                </li>
                <!-- <li class="active">
                ...
                <li>
                    <a href="user/404.html">My QR Codes</a>
                </li>
                <li>
                    <a href="user/404.html?status=A" class="active_count">Active (0)</a>
                </li>
                <li>
                    <a href="user/404.html?status=P" class="pause_count">Paused (0)</a>
                </li>
            </ul>
            </ul>
        </div>
...
<div class="modal" id="desgin_qrcode_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav popup_gntr_qrcode_setting_nav" id="gntr-tab-1" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="gntr_prebuilt_tab-1" data-toggle="pill"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="gntr_sticker_tab-1" data-toggle="pill"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="gntr_logo_tab-1" data-toggle="pill" href="#gntr_bgimg_1"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="popup_qr_preview_div">
                                    <div class="popup_qr_preview"  >
                                        <img loading="lazy"id="qrcode" src="assets/images/qr-code.png">
                                    </div>

                                    <a href="#" class="btn btn-default m-auto d-block show_size">More Sizes</a> <br/>
    ...
    <div class="modal fade" id="forgot_password_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="signup-free" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="col-md-6">
                            <form class="signup_form p-4 pl-0" method="POST" action="{{ route('custom_login') }}">
                                ...
                                <label class="radio mb-3">
                                     <input type="radio" name="login_type" value="login"> I'm an existing user
                                </label>
